...
RegisterCommand('checkprog', function(source, args)
    exports['progressbar']:Progress({
        name = "test_progress",
        duration = 5000,
        ...
        print("Progress bar completed in checkprog")
        TriggerEvent("chat:addMessage", {
            color = {0, 255, 0},
            multiline = true,
            args = {"System", "Progress bar completed in checkprog!"}
        })
    end, function() 
        TriggerEvent("chat:addMessage", {
            color = {255, 0, 0},
            multiline = true,
            args = {"System", "Progress bar cancelled in checkprog!"}
        })
    end)
end, false)
